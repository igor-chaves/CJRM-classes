/*　01
    ...
    - Implemente uma segunda função que exibe, no console, seus dados de usuário 
      do GitHub.
*/
// fetch("https://github.com/igor-chaves")
    // .then(console.log("OK IGOR"))
...
const newNum = numbers.filter(num => num % 2 === 0 || num % 3 === 0)
console.log(numbers)
console.log(newNum)
...
/* 03
    ...
    - A língua do "P" é uma brincadeira onde você coloca a letra "P" antes de 
      cada sílaba de uma palavra falada, como se você estivesse falando em código;
    - Exemplos de nomes na "língua do 'P'":
    - Roger => "PRoPger";
    - Natália => "PNaPtáPlia";
    - Rafaela => "PRaPfaPePla".
*/
const myName = Array.from("Igor")
let newName = ""

myName.map(letter => {
    if(letter === "I" || letter === "g") {return newName += "P" + letter}
    newName += letter
})
console.log(myName)
console.log(newName)
...
*/
const name = Array.from("Igor")
name.map((letter, index) => console.log(`${letter} é a ${index + 1}ª letra do meu nome.`))
