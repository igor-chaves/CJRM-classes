...
const generateMovieMsg = ({ title, directedBy }) => message += `\n  - ${title}, dirigido por ${directedBy}` 
best2019Movies.forEach(generateMovieMsg)
console.log(message)
...
/* 02
    - No objeto abaixo, implemente um método que exiba no console:
...
const youtubeUser = {
    ...
    showMsg() {
        ...
        this.videos.recentVideos.forEach(({ title }) => console.log(title))
    }
}
youtubeUser.showMsg()
