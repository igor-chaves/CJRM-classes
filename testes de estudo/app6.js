...
*/
function multiply(n1 = 1, n2 = 1) {return n1 * n2}
...
/* 02
  - Faça o mesmo que o exercício acima pede, mas desta vez, implemente uma  
    **function expression** que retorne o resultado da **divisão** entre esses  
    2 números.
*/
const divide = function(n1 = 1, n2 = 1) {return n1 / n2}
...
/* 03
  - Implemente uma função que apenas exiba no console o valor recebido por  
    parâmetro;
...
*/
const showMessage = function(msg = "empty") {return msg}
for (let i = 1; i < 8; i++) {
    console.log(showMessage(`Esta é a ${i}ª vez que essa string é exibida.`))
}
